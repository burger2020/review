...
public class ProgressWheel extends View {
    ...
    public ProgressWheel(Context context, AttributeSet attrs) {
        ...
        parseAttributes(context.obtainStyledAttributes(attrs, R.styleable.imagepicker_ProgressWheel));
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius =
                (int) a.getDimension(R.styleable.imagepicker_ProgressWheel_matProg_circleRadius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.imagepicker_ProgressWheel_matProg_fillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.imagepicker_ProgressWheel_matProg_barWidth, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.imagepicker_ProgressWheel_matProg_rimWidth, rimWidth);
        ...
        barSpinCycleTime =
                a.getInt(R.styleable.imagepicker_ProgressWheel_matProg_barSpinCycleTime, (int) barSpinCycleTime);
        ...
        linearProgress = a.getBoolean(R.styleable.imagepicker_ProgressWheel_matProg_linearProgress, false);

        if (a.getBoolean(R.styleable.imagepicker_ProgressWheel_matProg_progressIndeterminate, false)) {
            spin();
        }
